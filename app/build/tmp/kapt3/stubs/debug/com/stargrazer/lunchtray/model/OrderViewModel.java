...
public final class OrderViewModel extends androidx.lifecycle.ViewModel {
    ...
    private final androidx.lifecycle.MutableLiveData<com.stargrazer.lunchtray.model.MenuItem> _entree = null;
    @org.jetbrains.annotations.NotNull()
    private final androidx.lifecycle.LiveData<com.stargrazer.lunchtray.model.MenuItem> entree = null;
    private final androidx.lifecycle.MutableLiveData<com.stargrazer.lunchtray.model.MenuItem> _side = null;
    @org.jetbrains.annotations.NotNull()
    private final androidx.lifecycle.LiveData<com.stargrazer.lunchtray.model.MenuItem> side = null;
    private final androidx.lifecycle.MutableLiveData<com.stargrazer.lunchtray.model.MenuItem> _accompaniment = null;
    @org.jetbrains.annotations.NotNull()
    private final androidx.lifecycle.LiveData<com.stargrazer.lunchtray.model.MenuItem> accompaniment = null;
    ...
    @org.jetbrains.annotations.NotNull()
    public final java.util.Map<java.lang.String, com.stargrazer.lunchtray.model.MenuItem> getMenuItems() {
        return null;
    }
    
    @org.jetbrains.annotations.NotNull()
    public final androidx.lifecycle.LiveData<com.stargrazer.lunchtray.model.MenuItem> getEntree() {
        return null;
    }
    
    @org.jetbrains.annotations.NotNull()
    public final androidx.lifecycle.LiveData<com.stargrazer.lunchtray.model.MenuItem> getSide() {
        return null;
    }
    
    @org.jetbrains.annotations.NotNull()
    public final androidx.lifecycle.LiveData<com.stargrazer.lunchtray.model.MenuItem> getAccompaniment() {
        return null;
    }
