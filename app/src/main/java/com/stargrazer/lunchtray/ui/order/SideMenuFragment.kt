...
import com.stargrazer.lunchtray.databinding.FragmentSideMenuBinding
...
class SideMenuFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.apply {
            ...
            // TODOx: initialize the SideMenuFragment variables
     ...
     */
    fun goToNextScreen() {
        // TODOx: Navigate to the AccompanimentMenuFragment
