...
import com.stargrazer.lunchtray.databinding.FragmentAccompanimentMenuBinding
...
class AccompanimentMenuFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.apply {
            ...
            // TODOx: initialize the AccompanimentMenuFragment variables
     ...
     */
    fun goToNextScreen() {
        // TODOx: Navigate to the CheckoutFragment
     ...
     */
    fun cancelOrder() {
        // TODOx: Reset order in view model
        sharedViewModel.resetOrder()
        // TODOx: Navigate back to the [StartFragment] to start over
