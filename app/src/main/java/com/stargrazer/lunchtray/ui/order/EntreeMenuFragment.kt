...
import com.stargrazer.lunchtray.databinding.FragmentEntreeMenuBinding
...
class EntreeMenuFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.apply {
            ...
            // TODOx: initialize the EntreeMenuFragment variables
     ...
     */
    fun goToNextScreen() {
        // TODOx: Navigate to the SideMenuFragment
